<template>
  ...
  <div>
    <div class="p-3 m-3">
      Total User: {{ users_count !== undefined ? users_count : 0 }}
    </div>
  </div>
</template>
  ...
  <div>
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
      ...
      <p class="mt-6 text-gray-500 leading-relaxed">
        Laravel provides a beautiful, robust starting point for your next
        Laravel application. Laravel is designed to help you build your
